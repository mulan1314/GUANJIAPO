	...
	<div id="divAll">
		...
		<div style="padding: 20px 80px" class="input-group">
			<span class="input-group-addon">用户名</span> <input type="text"
				class="form-control" id="cuser_id" name="user_id"
				placeholder="请输入您的工号">
		...
		<div style="padding: 20px 80px" class="input-group">
			<span class="input-group-addon">密&nbsp;&nbsp;&nbsp;&nbsp;码</span> <input
				type="text" class="form-control" id="cuser_password"
				name="user_password" placeholder="请输入您的密码">
		</div>
		<!-- 密码框结束 -->
		<!-- 按钮div -->
