		...
		<nav class="navbar navbar-default" role="navigation">
			<div class="container-fluid">
				<div class="navbar-header">
					<center>
						<a class="navbar-brand" href="User.jsp">管家婆</a>
				</div>
				<div>
					<ul class="nav navbar-nav navbar-right">
						...
						<li class="dropdown active">
							...
							<ul class="dropdown-menu">
								<li><a href="ShowMsg.jsp"><span class="glyphicon glyphicon-user">个人信息</span></a></li>
								<li class="divider"></li>
								<li><a href="#"><span class="glyphicon glyphicon-bell">消息</span></a></li>
								<li class="divider"></li>
								<li><a href="login.jsp"><span class="glyphicon glyphicon-refresh">重新登录</span></a></li>
							</ul>
						</li>
					</ul>
				</div>
